...
feature_extractor = ViTFeatureExtractor.from_pretrained('vit-front-page-384-complete-v2/checkpoint-30000')
model = ViTForImageClassification.from_pretrained('vit-front-page-384-complete-v2/checkpoint-30000')
